...
export default (appOperation: AppOperation) => ({
  ...
  updateKyc: (data: any) =>
    appOperation.post('user/update-kyc', data, CUSTOMER_TYPE),
  ...
  bankVerifiyKyc: (data: any) =>
    appOperation.post('user/verifybankaccount', data, CUSTOMER_TYPE),
  ...
  payout: (data: any) =>
    appOperation.post('payment/payout', data, CUSTOMER_TYPE),
});
