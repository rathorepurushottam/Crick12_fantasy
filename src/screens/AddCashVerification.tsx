...
const AddCashVerification = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      title: 'Pan Card',
      image: panIcon,
      panding: kycDetails?.pan_verified,
    },
    // {
    //     id: 3,
  ...
  const renderItem = (item: any) => {
    return (
      <TouchableOpacityView
        ...
        {item.panding == 2 ? (
          <AppText weight={POPPINS_SEMI_BOLD} color={GREEN}>
            Pending
          </AppText>
        ) : item?.panding == 1 ? (
          <AppText weight={POPPINS_SEMI_BOLD} color={GREEN}>
  ...
  return (
    <AppSafeAreaView
      ...
      <KeyBoardAware
        ...
        <AppText
          color={WHITE}
          style={[styles.headerText, {marginTop: '10%'}]}
          type={SIXTEEN}
        ...
        <AppText
          color={WHITE}
          style={[styles.marginTop, {marginBottom: 10}]}
          type={THIRTEEN}
          weight={POPPINS_SEMI_BOLD}>
      ...
      <View style={styles.bottomButton}>
        <PrimaryButton
          ...
          onPress={
            kycDetails?.adhar_verified == 2
              ? toastAlert.showToastError('Your Aadhar verification is pending')
              : onSubmit
          }
