...
const CustomDrawer = () => {
  ...
  const onSubmit = (id: any, title: any) => {
    ...
    if(id == '2') return NavigationService.navigate(KYC_SCREEN)
    if (id >= '4' || id == '11')
        ...
        <TouchableOpacityView
          ...
          <View
            ...
            <FastImage
              ...
              resizeMode="contain"
              style={[item?.id == 2 ?styles.kycImage :styles.imageicon]}
              tintColor={tintColor}
            />
...
const styles = StyleSheet.create({
  ...
  verifiedContainer:{marginTop:10,backgroundColor:colors.green,borderRadius:4,padding:4,marginLeft:5},
  notVerifiedCOntainer:{marginTop:10,backgroundColor:colors.lightRed,borderRadius:4,padding:4,marginLeft:5}
});
