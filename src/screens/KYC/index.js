    ...
    <AppSafeAreaView  style={{backgroundColor:"#111019"}}>
      ...
      {/* <CommonImageBackground common> */}
        ...
        <KeyBoardAware style={styles.bottomContainer}>
          ...
          {/* <TouchableOpacityView style={{ width: "80%" }} onPress={() => isVerified('Aadhar') ?
              toastAlert.showToastError('Your Aadhar have been Verfied') :
              checkInProgress('Aadhar') ?
                toastAlert.showToastError('Your Aadhar have been progress') :
                NavigationService.navigate(VERIFY_ADHAAR_SCREEN)}>
          ...
          >
            ...
            <AppText
              ...
              style={{ marginLeft: 30 }}
            >
             {checkInProgress('Aadhar') ?  'Aadhar using OTP'  : 'Aadhar KYC is completed'}
            </AppText>
          </LinearGradient>
        </TouchableOpacityView> */}
