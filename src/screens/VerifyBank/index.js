...
const VerifyBank = () => {
  ...
  useEffect(()=>{
    setAccountNo(kycDetails?.bank_details?.account_number);
        ...
        <KeyBoardAware style={styles.bottomContainer}>
          ...
          <View style={styles.box}>
            ...
            <InputBox
              ...
              textInputBox={styles.textInputBox}
              maxLength={11}
              editable={kycDetails?.bank_details?.ifsc ? false : true}
            />
            ...
            <InputBox
              ...
              textInputBox={styles.textInputBox}
              editable={kycDetails?.bank_details?.bank_name ? false : true}
            />
            <InputBox
