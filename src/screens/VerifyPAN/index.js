...
const VerifyPAN = () => {
  ...
  const onSubmit = () => {
    ...
    // else if (name != kycDetails?.adahr_details?.adahr_name) {
    //   toastAlert.showToastError('Your Name does not match with aadhar');
    // }
    // else if (!dob) {
    ...
    // }
      ...
      console.log(data, '===== in pan verify');
      ...
      <KeyBoardAware style={styles.bottomContainer}>
        ...
        <View style={styles.box}>
          ...
          {/* <TouchableOpacityView
              ...
              <AppText type={THIRTEEN} weight={POPPINS_SEMI_BOLD} color={dob ? 'black' : 'gray'}>
